...
const LoadMore = ({ onClick }: { onClick: () => Promise<void> }) => {
  ...
  return (
    <div className="pt-6 flex flex-col items-center gap-2">
      ...
      {failed && (
        <p className="font-mono text-[11px] tracking-[0.12em] text-danger">
