            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center flex-wrap items-center gap-6 text-muted-foreground text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-medium text-foreground">{blog.author?.name || 'Anonymous Author'}</p>
              ...
              <div className="bg-muted rounded-2xl p-8 mb-12">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-2xl font-bold text-foreground mb-2">{blog.author.name || 'Anonymous Author'}</h3>
                    <p className="text-muted-foreground mb-4">Passionate writer at Quill, sharing insights and stories that matter.</p>
